...
public class MainFoodListAdapter extends RecyclerView.Adapter<MainFoodListAdapter.MainFoodListViewHolder> {


    Context context;
    ArrayList<FoodData> foodList;

    public MainFoodListAdapter(Context context, ArrayList<FoodData> foodList) {
    ...
    @NonNull
    @Override
    public MainFoodListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_item_list, parent, false);
        return new MainFoodListViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MainFoodListViewHolder holder, int position) {
    ...
    public class MainFoodListViewHolder extends RecyclerView.ViewHolder {
        ImageView imgFood;
        TextView txtFoodName, txtFoodPrice;

        public MainFoodListViewHolder(@NonNull View itemView) {
            super(itemView);
